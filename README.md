...
| `view`              | `string`  | No         | `default`                      | Rendering mode: `default` (3D Monolith), `monthly` (Compact monthly stats), `heatmap` (flat 2D contribution heatmap), `pulse` (heartbeat sparkline), or `skyline` (scenic city skyline) |
...
| `view`            | Rendering mode                                                                                  | `default`          | `default`, `monthly`, `heatmap`, `pulse`, `skyline`                             | `?view=skyline`          |
...
<!-- Scenic City Skyline View -->

![](https://commitpulse.vercel.app/api/streak?user=jhasourav07&view=skyline)
